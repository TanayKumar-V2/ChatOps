...
export function LoginPage({ onAuthenticated }: Props) {
  ...
  async function submit(event: React.FormEvent) {
    ...
    } catch (cause) { setError(cause instanceof Error ? cause.message : registering ? "We couldn't create your account. Please try again." : "We couldn't sign you in. Check your details and try again."); }
